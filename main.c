 ...
 *
 * EN ARCHIVO _read.c, por qu� aparece EXIT SUCCESS en la siguiente instrucci�n??
 * if (len_of_read == -1)
 *
 *
 *
 * PENDINGS
 *
 * DEBER�AMOS COLOCAR char *command_exit = "exit"; QUE EST� EN _READ.C, EN HEADER shs.h
 *
 ...
 *
 *
 * Informaci�n importante de los comandos resumida en este archivo:
